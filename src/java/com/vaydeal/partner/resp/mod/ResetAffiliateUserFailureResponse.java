 ...
 * @author rifaie
 */
public class ResetAffiliateUserFailureResponse {

    private final ResetAffiliateUserResult reqR;
    private final String error;

    public ResetAffiliateUserFailureResponse(ResetAffiliateUserResult reqR, String error) {
        this.reqR = reqR;
        this.error = error;
    }
