 ...
 * @author rifaie
 */
public class ResetAffiliateUserSuccessResponse {
    private final String status;
    private final String accessToken;

    public ResetAffiliateUserSuccessResponse(String status, String accessToken) {
        this.status = status;
    ...
    public String toString() {
        ...
        if(status.equals(ResponseMsg.RESP_OK)){
            sb.append("<div id=\"msgStatus\" class=\"msg-status error\">User reset successfull </div>");
        }else{
