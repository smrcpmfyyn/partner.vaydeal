 ...
 * @author rifaie
 */
public class ChangeAffiliateUserStatusSuccessResponse {
    private final String status;
    private final String accessToken;

    public ChangeAffiliateUserStatusSuccessResponse(String status, String accessToken) {
        this.status = status;
    ...
    public String toString() {
        ...
        if(status.equals(ResponseMsg.RESP_OK)){
            sb.append("<div id=\"msgStatus\" class=\"msg-status error\">Status Changed </div>");
        }else{
