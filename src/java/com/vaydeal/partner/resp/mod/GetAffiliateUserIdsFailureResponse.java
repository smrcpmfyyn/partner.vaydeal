 ...
 * @author rifaie
 */
public class GetAffiliateUserIdsFailureResponse {

    private final GetAffiliateUserIdsResult reqR;
    private final String error;

    public GetAffiliateUserIdsFailureResponse(GetAffiliateUserIdsResult reqR, String error) {
        this.reqR = reqR;
        this.error = error;
    }
