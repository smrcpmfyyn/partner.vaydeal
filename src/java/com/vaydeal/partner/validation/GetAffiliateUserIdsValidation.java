 ...
 * @author rifaie
 */
public class GetAffiliateUserIdsValidation implements Validation {

    private final GetAffiliateUserIds req;
    private String paramValue = "";
    private String paramName = "";

    public GetAffiliateUserIdsValidation(GetAffiliateUserIds gu) {
        this.req = gu;
    }

    @Override
    public void validation() throws Exception {
        GetAffiliateUserIdsConstraints reqC = new GetAffiliateUserIdsConstraints(req);
        String valid = "";
