...
import com.vaydeal.partner.intfc.validation.GetFilterValidator;
 ...
 * @author rifaie
 */
public class GetFilterConstraints implements GetFilterValidator {

    private final GetFilter req;
    private final DBConnect dbc;
    private final MongoConnect mdbc;

    public GetFilterConstraints(GetFilter req) throws Exception {
        this.req = req;
