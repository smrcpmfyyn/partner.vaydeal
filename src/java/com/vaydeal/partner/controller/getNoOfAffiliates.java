...
import com.vaydeal.partner.processreq.ProcessGetNoOfAffiliates;
 ...
 * @author USER
 */
public class getNoOfAffiliates extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Logger.getLogger(getNoOfAffiliates.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
