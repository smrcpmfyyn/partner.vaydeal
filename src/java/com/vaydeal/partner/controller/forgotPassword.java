...
import com.vaydeal.partner.processreq.ProcessForgotPassword;
...
public class forgotPassword extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            ForgotPassword req = new ForgotPassword(uid, email);
            ...
            UserActivities ua = new UserActivities(req.getUid(), req.getAffiliate(), "forgot_password", req.getUser_type(), "valid");
